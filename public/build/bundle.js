...
var app = (function () {
    ...
    /* src\Form.svelte generated by Svelte v3.44.3 */
    ...
    function create_else_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	fa0 = new Fa$1({ props: { icon: faCheck }, $$inline: true });

    	function click_handler_4() {
    		return /*click_handler_4*/ ctx[10](/*task*/ ctx[2], /*each_value*/ ctx[11], /*task_index*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*task*/ ctx[2].completed ? "completed" : "") + " svelte-17r1xah"));
    			add_location(li, file$1, 68, 14, 2381);
    			add_location(button0, file$1, 70, 16, 2517);
    			attr_dev(button1, "class", "deleteBtn svelte-17r1xah");
    			add_location(button1, file$1, 71, 16, 2624);
    			attr_dev(div0, "class", "btn");
    			add_location(div0, file$1, 69, 14, 2482);
    			attr_dev(div1, "id", "list-task");
    			attr_dev(div1, "class", "svelte-17r1xah");
    			add_location(div1, file$1, 67, 10, 2345);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*deleteTodo*/ ctx[4](/*task*/ ctx[2].id))) /*deleteTodo*/ ctx[4](/*task*/ ctx[2].id).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*$todos*/ 2 && li_class_value !== (li_class_value = "" + (null_to_empty(/*task*/ ctx[2].completed ? "completed" : "") + " svelte-17r1xah"))) {
    ...
    function create_if_block_2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = !/*task*/ ctx[2].completed && create_if_block_3(ctx);
    ...
    // (48:10) {#if filter == 'completed'}
    function create_if_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*task*/ ctx[2].completed && create_if_block_1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:10) {#if filter == 'completed'}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	function click_handler_3() {
    		return /*click_handler_3*/ ctx[9](/*task*/ ctx[2], /*each_value*/ ctx[11], /*task_index*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "contenteditable", "true");
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*task*/ ctx[2].completed ? "completed" : "") + " svelte-17r1xah"));
    			add_location(li, file$1, 59, 12, 1922);
    			add_location(button0, file$1, 61, 16, 2058);
    			attr_dev(button1, "class", "deleteBtn svelte-17r1xah");
    			add_location(button1, file$1, 62, 16, 2166);
    			attr_dev(div0, "class", "btn");
    			add_location(div0, file$1, 60, 14, 2023);
    			attr_dev(div1, "id", "list-task");
    			attr_dev(div1, "class", "svelte-17r1xah");
    			add_location(div1, file$1, 58, 10, 1888);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, li);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:10) {#if !task.completed}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(li, "class", "completed svelte-17r1xah");
    			add_location(li, file$1, 50, 12, 1558);
    			attr_dev(button, "class", "deleteBtn svelte-17r1xah");
    			add_location(button, file$1, 52, 16, 1647);
    			attr_dev(div0, "class", "btn");
    			add_location(div0, file$1, 51, 14, 1612);
    			attr_dev(div1, "id", "list-task");
    			attr_dev(div1, "class", "svelte-17r1xah");
    			add_location(div1, file$1, 49, 10, 1524);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, li);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(49:10) {#if task.completed}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:10) {#each $todos as task}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button3.textContent = "Uncompleted";
    			t7 = space();
    			...
    			attr_dev(input, "placeholder", "Write a new task");
    			attr_dev(input, "class", "svelte-17r1xah");
    			add_location(input, file$1, 29, 6, 844);
    			attr_dev(button0, "class", "submit svelte-17r1xah");
    			attr_dev(button0, "type", "submit");
    			add_location(button0, file$1, 36, 6, 1006);
    			attr_dev(form, "id", "toDoForm");
    			attr_dev(form, "class", "svelte-17r1xah");
    			add_location(form, file$1, 28, 4, 796);
    			attr_dev(button1, "class", "svelte-17r1xah");
    			add_location(button1, file$1, 39, 6, 1120);
    			attr_dev(button2, "class", "svelte-17r1xah");
    			add_location(button2, file$1, 40, 6, 1178);
    			attr_dev(button3, "class", "svelte-17r1xah");
    			add_location(button3, file$1, 41, 6, 1248);
    			attr_dev(div, "class", "filters svelte-17r1xah");
    			add_location(div, file$1, 38, 4, 1091);
    			attr_dev(section0, "class", "form svelte-17r1xah");
    			add_location(section0, file$1, 27, 2, 768);
    			attr_dev(ul, "id", "list_container");
    			add_location(ul, file$1, 45, 6, 1383);
    			attr_dev(section1, "id", "todo_container");
    			attr_dev(section1, "class", "svelte-17r1xah");
    			add_location(section1, file$1, 44, 2, 1346);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*task*/ 4 && input.value !== /*task*/ ctx[2]) {
    				set_input_value(input, /*task*/ ctx[2]);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_3 = (task, each_value, task_index) => {
    		set_store_value(todos, each_value[task_index].completed = !task.completed, $todos);
    	};

    	const click_handler_4 = (task, each_value, task_index) => {
    		set_store_value(todos, each_value[task_index].completed = !task.completed, $todos);
    	};
